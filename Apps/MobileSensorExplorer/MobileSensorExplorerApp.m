classdef MobileSensorExplorerApp < handle
%
% Usage:
%     app.MobileSensorExplorerApp

  properties
      AppPath = {'/MobileSensorExplorer'};
	  AppClass = 'MobileSensorExplorerApp';
	  AppHandle;
	  AppCount = 0;
      Increment = 1;
	  Decrement = 0;
  ...
  methods
    ...
    function obj = MobileSensorExplorerApp()      
    ...
    function startApp(obj)
        ...
        if nargout(@MobileSensorExplorer) == 0  
            eval('MobileSensorExplorer');
        else
			obj.AppHandle = eval('MobileSensorExplorer');   
        end 
        % Increment the reference count by one    
        MobileSensorExplorerApp.refcount(obj.Increment);
